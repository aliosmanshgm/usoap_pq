...
import {
  renderProgramAddAudit, renderAuditList, renderAuditCard, statusPill, nextActionForAudit
...
service cloud.firestore {
  ...
  // Faz 8B.2: Cross-module callbacks are registered once after all domain functions exist.
  ...
  // Faz 8B.2: type=module içinde inline HTML olaylarının erişmesi gereken render fonksiyonları.
