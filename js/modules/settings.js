...
export function renderSettings() {
  ...
  el.innerHTML = `<div class="grid">
    ...
    <div class="card span-12"><h3>Faz 8B.6 Modüler Mimari</h3><p>Kimlik doğrulama ve kullanıcı profilleri <code>auth-users.js</code>, bildirim/son tarih mantığı <code>notifications.js</code>, Ayarlar/Yetkiler görünümü ise <code>settings.js</code> içine ayrılmıştır. Faz 8A veri güvenliği ve CAP veri bütünlüğü kuralları korunmuştur.</p></div>
  </div>`;
}
